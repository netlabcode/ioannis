...
def emptyNet():
    ...
    net.addLink(s999, r0, intfName2='r0-eth1', params2={'ip': '100.0.0.1/16'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s51, r5, intfName2='r5-eth1', params2={'ip': '100.5.0.1/16'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s61, r6, intfName2='r6-eth1', params2={'ip': '100.6.0.1/16'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s71, r7, intfName2='r7-eth1', params2={'ip': '100.7.0.1/16'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s211, r21, intfName2='r21-eth1', params2={'ip': '100.21.0.1/16'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s241, r24, intfName2='r24-eth1', params2={'ip': '100.24.0.1/16'},delay='5ms', cls=TCLink, bw=10)
    ...
    net.addLink(s05m1,s53, intfName1='s05m1-eth1', params1={'ip':'100.5.0.11/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s05m2,s53, intfName1='s05m2-eth1', params1={'ip':'100.5.0.12/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s05m3,s53, intfName1='s05m3-eth1', params1={'ip':'100.5.0.13/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s05m4,s53, intfName1='s05m4-eth1', params1={'ip':'100.5.0.14/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s05m5,s53, intfName1='s05m5-eth1', params1={'ip':'100.5.0.15/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s05m6,s53, intfName1='s05m6-eth1', params1={'ip':'100.5.0.16/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s05cpc,s52)
    net.addLink(s05db,s52)
    net.addLink(s05gw,s51, intfName1='s05gw-eth1', params1={'ip':'100.5.0.23/24'},delay='5ms', cls=TCLink, bw=10)

    # Link Substation 06 Merging unit to Switch
    net.addLink(s06m1, s63, intfName1='s06m1-eth1', params1={'ip': '100.6.0.11/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m2, s63, intfName1='s06m2-eth1', params1={'ip': '100.6.0.12/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m3, s63, intfName1='s06m3-eth1', params1={'ip': '100.6.0.13/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m4, s63, intfName1='s06m4-eth1', params1={'ip': '100.6.0.14/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m5, s63, intfName1='s06m5-eth1', params1={'ip': '100.6.0.15/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m6, s63, intfName1='s06m6-eth1', params1={'ip': '100.6.0.16/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m7, s63, intfName1='s06m7-eth1', params1={'ip': '100.6.0.17/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m8, s63, intfName1='s06m8-eth1', params1={'ip': '100.6.0.18/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06m9, s63, intfName1='s06m9-eth1', params1={'ip': '100.6.0.19/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s06cpc, s62)
    net.addLink(s06db, s62)
    net.addLink(s06gw, s61, intfName1='s06gw-eth1', params1={'ip': '100.6.0.23/24'},delay='5ms', cls=TCLink, bw=10)

    # Link Substation 07 Merging unit to Switch
    net.addLink(s07m1, s73, intfName1='s07m1-eth1', params1={'ip': '100.7.0.11/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m2, s73, intfName1='s07m2-eth1', params1={'ip': '100.7.0.12/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m3, s73, intfName1='s07m3-eth1', params1={'ip': '100.7.0.13/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m4, s73, intfName1='s07m4-eth1', params1={'ip': '100.7.0.14/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m5, s73, intfName1='s07m5-eth1', params1={'ip': '100.7.0.15/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m6, s73, intfName1='s07m6-eth1', params1={'ip': '100.7.0.16/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m7, s73, intfName1='s07m7-eth1', params1={'ip': '100.7.0.17/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m8, s73, intfName1='s07m8-eth1', params1={'ip': '100.7.0.18/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m9, s73, intfName1='s07m9-eth1', params1={'ip': '100.7.0.19/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07m10, s73, intfName1='s07m10-eth1', params1={'ip': '100.7.0.20/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s07cpc, s72)
    net.addLink(s07db, s72)
    net.addLink(s07gw, s71, intfName1='s07gw-eth1', params1={'ip': '100.7.0.23/24'}, delay='5ms', cls=TCLink, bw=10)

    # Link Substation 21 Merging unit to Switch
    net.addLink(s21m1, s213, intfName1='s21m1-eth1', params1={'ip': '100.21.0.11/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s21m2, s213, intfName1='s21m2-eth1', params1={'ip': '100.21.0.12/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s21m3, s213, intfName1='s21m3-eth1', params1={'ip': '100.21.0.13/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s21m4, s213, intfName1='s21m4-eth1', params1={'ip': '100.21.0.14/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s21m5, s213, intfName1='s21m5-eth1', params1={'ip': '100.21.0.15/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s21m6, s213, intfName1='s21m6-eth1', params1={'ip': '100.21.0.16/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s21cpc, s212)
    net.addLink(s21db, s212)
    net.addLink(s21gw, s211, intfName1='s21gw-eth1', params1={'ip': '100.21.0.23/24'}, delay='5ms', cls=TCLink, bw=10)

    # Link Substation 24 Merging unit to Switch
    net.addLink(s24m1,s243, intfName1='s24m1-eth1', params1={'ip':'100.24.0.11/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s24m2,s243, intfName1='s24m2-eth1', params1={'ip':'100.24.0.12/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s24m3,s243, intfName1='s24m3-eth1', params1={'ip':'100.24.0.13/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s24m4,s243, intfName1='s24m4-eth1', params1={'ip':'100.24.0.14/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s24m5,s243, intfName1='s24m5-eth1', params1={'ip':'100.24.0.15/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s24m6,s243, intfName1='s24m6-eth1', params1={'ip':'100.24.0.16/24'},delay='5ms', cls=TCLink, bw=10)
    net.addLink(s24cpc,s242)
    net.addLink(s24db,s242)
    net.addLink(s24gw,s241, intfName1='s24gw-eth1', params1={'ip':'100.24.0.23/24'}, delay='5ms', cls=TCLink, bw=10)
    ...
    info( net[ 's05gw' ].cmd( 'ip route add 100.0.0.0/24 via 100.5.0.1 dev s05gw-eth1' ) )
    ...
    info( net[ 's05gw' ].cmd( 'ip route add 200.0.0.0/8 via 100.5.0.1 dev s05gw-eth1' ) )
    ...
    info( net['s06gw'].cmd('ip route add 100.0.0.0/24 via 100.6.0.1 dev s06gw-eth1'))
    ...
    info( net['s06gw'].cmd('ip route add 200.0.0.0/8 via 100.6.0.1 dev s06gw-eth1'))
    ...
    info(net['s07m10'].cmd('ip route add 100.0.0.0/24 via 100.7.0.1 dev s07m10-eth1'))
    info( net['s07gw'].cmd('ip route add 100.0.0.0/24 via 100.7.0.1 dev s07gw-eth1'))
    ...
    info(net['s07m10'].cmd('ip route add 200.0.0.0/8 via 100.7.0.1 dev s07m10-eth1'))
    info( net['s07gw'].cmd('ip route add 200.0.0.0/8 via 100.7.0.1 dev s07gw-eth1'))
    ...
    info(net['s21gw'].cmd('ip route add 100.0.0.0/24 via 100.21.0.1 dev s21gw-eth1'))
    ...
    info(net['s21gw'].cmd('ip route add 200.0.0.0/8 via 100.21.0.1 dev s21gw-eth1'))
    ...
    info( net[ 's24gw' ].cmd( 'ip route add 100.0.0.0/24 via 100.24.0.1 dev s24gw-eth1'))
    ...
    info( net[ 's24gw' ].cmd( 'ip route add 200.0.0.0/8 via 100.24.0.1 dev s24gw-eth1'))
